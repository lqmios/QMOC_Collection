...
@interface MainViewController_4 ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        QMDynamicAddCellController *dynamic = [[QMDynamicAddCellController alloc]init];
